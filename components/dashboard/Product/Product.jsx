...
const ProductCard = React.memo(({ product, onEdit, onDelete }) => {
  const { Image: ProductImage, Name, PriceFormatted, Sizes, IsVisible } = product;
        ...
        >
          ...
          <CardContent className="p-2 sm:p-4">
            ...
            <motion.span
                ...
                className={`inline-block px-2 py-1 text-xs font-semibold rounded-full ${IsVisible ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'}`}
            >
