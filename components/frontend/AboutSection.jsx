...
const AboutSection = () => {
  ...
  return (
    <section id="about-us" className="container my-6 md:px-20 mx-auto md:my-10 flex flex-col md:flex-row items-center justify-between rounded-2xl p-6 md:p-10 gap-10 md:gap-40">
