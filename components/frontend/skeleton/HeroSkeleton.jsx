    ...
    return (
        <section
            ...
            <div className="flex-1 flex justify-center">
                <Skeleton
                    className="h-[380px] w-[280px] md:h-[380px] md:w-[280px] lg:h-[480px] lg:w-[340px] rounded-tl-[70px] shadow-md rounded-br-[70px] lg:rounded-tl-[100px] lg:rounded-br-[100px] rounded-tr-md rounded-bl-md mx-auto mb-6 lg:mb-0 lg:ml-[160px] shadow-[0_8px_25px_rgba(0,0,0,0.6)] object-cover transition-opacity duration-500"/>
            </div>
        </section>
    );
};
